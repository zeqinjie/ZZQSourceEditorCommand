...
#import "JosnModelEditorCommand.h"

@implementation JosnModelEditorCommand
{
...
- (void)performCommandWithInvocation:(XCSourceEditorCommandInvocation *)invocation completionHandler:(void (^)(NSError * _Nullable nilOrError))completionHandler
{
    ...
    [self jsonModelEditWithInvocation:invocation completionHandler:completionHandler];
}


- (void)jsonModelEditWithInvocation:(XCSourceEditorCommandInvocation *)invocation
